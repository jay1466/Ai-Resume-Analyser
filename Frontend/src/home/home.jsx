        ...
        <div className={Styles.container}>
           ...
           {isshow && islogged? <div id="menu" className={Styles.profilemenu}>
                ...
                <div id="menu"className={Styles.pmenusec}>
                    <button id="menu" onClick={() => navigate("/profile")} disabled={isloading} >My History</button>
            ...
            <img  className={Styles.bg} src="/Analysis.png" alt="AnalysisBg" />
            <div className={Styles.core}>
                ...
                <div className={Styles.btncontainer} >
                    ...
                    {isprevious?<button disabled={isloading} onClick={()=>navigate("/profile")}>Resume History</button>:null}
                </div>
            </div>
